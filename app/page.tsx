...
import { 
  TrendingUp, Wallet, ArrowUpRight, Lock, Building, PieChart, Calculator, Activity, ChevronRight 
} from "lucide-react";
                ...
                <div className="relative overflow-hidden rounded-[32px] border border-zinc-800 bg-zinc-950 p-8 h-full transition-all duration-300 group-hover:border-emerald-500/30 group-hover:scale-[1.01] shadow-2xl">
                    ...
                    <div className="relative z-10 flex flex-col justify-between h-full min-h-[180px]">
                        <div className="flex justify-between items-start mb-8">
                            ...
                            <div className="h-8 w-8 rounded-full border border-zinc-800 flex items-center justify-center text-zinc-600 group-hover:text-white group-hover:border-zinc-600 transition-colors">
                        ...
                        <div>
                            ...
                            <p className="text-zinc-500 text-sm font-medium">
                                Bourse, Crypto, Cash. <span className="text-emerald-500">Liquide & Disponible.</span>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative overflow-hidden rounded-[32px] border border-zinc-800 bg-zinc-950 p-8 h-full transition-all duration-300 group-hover:border-blue-500/30 group-hover:scale-[1.01] shadow-2xl">
                    ...
                    <div className="relative z-10 flex flex-col justify-between h-full min-h-[180px]">
                        ...
                        <div>
                            ...
                            <p className="text-zinc-500 text-sm font-medium">
                                Résidence principale & Locatif (Brut).
                            </p>
                        </div>
                    </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="p-8 rounded-[28px] bg-zinc-900/50 border border-zinc-800/50 hover:bg-zinc-900 hover:border-zinc-700 transition-all h-full flex flex-col justify-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <span className="text-[10px] font-black px-2 py-1 rounded bg-yellow-500/20 text-yellow-500 border border-yellow-500/20">
            ...
            <div className="md:col-span-2 p-8 rounded-[28px] bg-zinc-900/50 border border-zinc-800/50 flex flex-col justify-center relative overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-6 gap-4">
                    <div>
                        <p className="text-xs font-bold text-emerald-500 uppercase mb-2 tracking-widest">Prochain objectif</p>
                        <div className="text-3xl font-black text-white flex items-center gap-2">
                             <AnimatedNumber value={milestone}/>
                        </div>
                    </div>
                    <div className="text-right">
                        <span className="text-4xl font-black text-zinc-700">{((totalNetWorth / milestone) * 100).toFixed(0)}%</span>
                    </div>
                </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="relative p-5 rounded-2xl bg-black border border-zinc-900 opacity-50 cursor-not-allowed flex items-center gap-4 overflow-hidden grayscale">
                    ...
                    <div className="h-12 w-12 rounded-xl bg-zinc-900 text-zinc-500 flex items-center justify-center">
                        <Lock size={22}/>
                    </div>
                    <div>
                        <p className="font-bold text-zinc-400 text-sm">Analyse IA 2.0</p>
