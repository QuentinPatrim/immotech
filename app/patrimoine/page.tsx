...
import { Wallet, Building, Bitcoin, Landmark, Plus, Trash2, TrendingUp, ArrowUpRight, PieChart as PieIcon, Euro } from "lucide-react";
    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-black text-zinc-100 font-sans">
      ...
      <main className="flex-1 w-full max-w-full overflow-y-auto overflow-x-hidden p-3 md:p-8 pb-24 md:pb-8">
        ...
        >
          ...
          {/* --- ADD ASSET BAR (MODIFIÉ : € + No Spinners) --- */}
            ...
            <div className="bg-zinc-950 rounded-lg p-4 flex flex-col lg:flex-row gap-4 items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 w-full">
                    ...
                    <div className="relative">
                        {/* CORRECTION : Classes CSS pour cacher les flèches + Icône Euro */}
                        <Input 
                            type="number" 
                            placeholder="Valeur" 
                            value={newValue} 
                            onChange={(e) => setNewValue(e.target.value)} 
                            className="bg-zinc-900 border-zinc-800 pr-8 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" 
                        />
                        <Euro className="absolute right-3 top-2.5 text-zinc-500" size={14}/>
                    </div>
                </div>
