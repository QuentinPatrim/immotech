...
export async function POST(req: Request) {
  try {
    ...
    // DEBUG : Ceci va s'afficher dans ton terminal pour vérifier si les données arrivent !
    console.log("📊 DONNÉES REÇUES PAR L'API :", context);
    ...
    const systemPrompt = `
      ...
      ${JSON.stringify(context || "Aucune donnée fournie pour le moment.")}
    `;
