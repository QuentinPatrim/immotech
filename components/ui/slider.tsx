...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    {/* TRACK (La barre totale / fond vide) : Doit être FONCÉE (Gris sombre) */}
    <SliderPrimitive.Track className="relative h-2 w-full grow overflow-hidden rounded-full bg-zinc-800">
      {/* RANGE (La partie remplie à gauche) : Doit être CLAIRE (Blanc) */}
      <SliderPrimitive.Range className="absolute h-full bg-white" />
    </SliderPrimitive.Track>
    
    {/* LE BOUTON (Thumb) : Blanc avec bordure noire pour le contraste */}
